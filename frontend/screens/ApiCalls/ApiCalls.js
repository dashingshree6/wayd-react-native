...
export const createPincodes = data => axios.post(`${API}/pin/create`, data);

export const addProductToCart = (data, id) =>
  axios.post(`${API}/add/${id}`, data);

export const createNewOrder = data => axios.post(`${API}/order/create`, data);

export const updateCartDetails = (action, id) =>
  axios.post(`${API}/update/${action}/${id}`);
