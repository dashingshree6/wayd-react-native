  ...
  React.useEffect(() => {
    ...
    axios
      ...
      .then(res => {
        ...
        console.log(`all Customer -----`, allSuppliers);
      })
      .catch(error => {
        ...
        <View
          ...
          <View style={{flex: 1, marginTop: 10}}>
            ...
            <Text
              ...
              {selectedDetail?.role == 3 ? 'Customer' : 'Wrong Data'}
            </Text>
          </View>
          <View style={{flex: 1, marginTop: 10}}>
            <Text>Shop Name</Text>
          ...
          <ScrollView>
            <View style={{flex: 1, marginTop: 10}}>
              ...
              <TextInput
                ...
                placeholder={
                  selectedDetail?.role == 0 ? 'Customer' : 'Enter Customer Role'
                }
                onChangeText={val => {
            ...
            <View style={{flex: 1, marginTop: 10}}>
              ...
              <TextInput
                ...
                placeholder={
                  selectedDetail?.shop ? selectedDetail.shop : `Enter Shop Name`
                }
                onChangeText={val => {
