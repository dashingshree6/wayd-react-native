...
// export default function SelectSupplierForm({ navigation }) {
//   return (
//     <View>
//       <Text>ProcurementForm</Text>
//     </View>
//   )
// }
...
export default function SelectSupplierForm({ navigation }) {
        ...
        getAllUsers()
          .then((res) => {
            if (res.error) {
              ...
              setUsersList(res.data.filter(i => i.role === 2))
              setLoading(false)
            }
          })
  ...
  return (
    <View style={styles.sales_order_view}>
                    ...
                    { tabIndex == 2 && (
                      <Checkout goToFirstTab={goToFirstTab} />
                    )}
